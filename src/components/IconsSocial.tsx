...
function IconsSocial() {
  return (
    <div className="icons-social">
      ...
      <a target="_blank" rel="noopener noreferrer" href="https://twitter.com/DGlup3">
        <i className="fab fa-twitter"></i>
      </a>
      <a target="_blank" rel="noopener noreferrer" href="https://www.instagram.com/glup3/">
        <i className="fab fa-instagram"></i>
      </a>
      <a target="_blank" rel="noopener noreferrer" href="https://www.youtube.com/channel/UCN8LfiD2wp_DmTbiVXNhl0g">
        <i className="fab fa-youtube"></i>
      </a>
      <a target="_blank" rel="noopener noreferrer" href="https://www.paypal.me/glup3tran">
