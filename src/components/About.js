    ...
    <section>
      <div className="block container">
        <div className="scrollspy" id="about">
          <Fade left duration={1500}><h1>About</h1></Fade>
          <Fade left duration={1500}> <p className="flow-text">Phuc Tran | 17 years old | Student</p></Fade>
          <Fade left duration={1500}><p className="flow-text">
          ...
          <Fade left duration={1500}> <blockquote className="flow-text">
