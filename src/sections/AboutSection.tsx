...
const AboutSection = () => {
  return (
    <SectionWrapper id="about">
      ...
      <Fade left duration={1500}>
        <p className="flow-text">
          In the first years we learn <span className="blue lighten-4">object orientated programming</span> basics and
          patterns. We start with simple console applications, continue with desktop application and graduate with{' '}
          <span className="blue lighten-4">mobile and web</span> applications. After 5 years of school we are skilled
          enough to <span className="blue lighten-4">solve</span> all kinds of{' '}
      ...
      <Fade left duration={1500}>
        <p className="flow-text">
          ...
          <span className="blue lighten-4">taekwondo</span>, running, skating, reading books / mangas / light novels,
